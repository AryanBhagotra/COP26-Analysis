...
| __Nitrous Oxide__ | This is the third most emitted greenhouse gas, produced during industrial processes. Known informally as laughing gas, nitrous oxide is a staggering 300 x more potent that carbon monoxide.  |
...
| __Particulate Matter 2.5__ | Particles that are 2.5 microns or less are defined as PM2.5, these particles can travel far deep into the respiratory tract, even reaching the lungs! They can cause short and long term health effects.|
...
- __Pandas:__ We explored this in our initial research. It’s a very powerful library to handle tabular data.
